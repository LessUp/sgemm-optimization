...
This is the detailed catalog behind the [Resources Hub](/en/resources/). The goal is not to dump links; it is to show which source helps with which kind of SGEMM question.

## How to use this page

- Start with the [Resources Hub](/en/resources/) if you need help choosing a route.
- Use this page when you already know the category of source you need.
- Continue to [Further Reading Routes](/en/resources/further-reading) when the right next topic matters more than the right citation.
...
- It connects directly to the repository's [Diagnosis Loop](/en/methodology/diagnosis-loop), [Benchmark Scope](/en/validation/benchmark-scope), and [Reproducibility](/en/validation/reproducibility) pages.
...
- [Further Reading Routes](/en/resources/further-reading) for curated paths on tiling, occupancy, roofline thinking, Tensor Core constraints, and profiling.
- [CUDA Memory Cheat Sheet](/en/cuda-memory-cheatsheet) for a fast memory refresher before reopening kernel code.
- [Resources Hub](/en/resources/) for scenario-based entry points back into the rest of the site.
