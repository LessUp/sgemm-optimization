...
Read this page together with [Benchmark Results](/en/validation/benchmark-results) and [Benchmark Scope](/en/validation/benchmark-scope) before comparing Tensor Core numbers against FP32 kernels.
