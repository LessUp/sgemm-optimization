...
This quick sheet is now part of the [Resources Hub](/en/research/). Use it when you need to re-orient yourself before reopening kernel code, profiler output, or WMMA constraints.

## When this page is most useful

- Right before reading [Memory Flow](/en/architecture/memory-flow) or [Tiled Kernel](/en/academy/kernel-tiled) again.
...
- [Further Reading Routes](/en/research/further-reading)
- [Curated References](/en/research/references)
