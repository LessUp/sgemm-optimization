...
Define the repository's normative governance model, including authoritative specification ownership, instruction-file responsibility boundaries, automation policy, and shared developer tooling expectations for archive-ready maintenance.
